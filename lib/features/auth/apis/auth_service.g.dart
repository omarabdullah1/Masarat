...
class _AuthenticationService implements AuthenticationService {
  ...
  Future<CreateAccountResponse> createAccount(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(createAccountRequestBody.toJson());
  ...
  @override
  Future<dynamic> uploadAcademicDegree(File file) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<SuccessResponse> sendOtp(SendOtpRequestBody sendOtpRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<SuccessResponse> resetPasswordWithOtp(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(resetPasswordOtpRequestBody.toJson());
    final _options = _setStreamType<SuccessResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  Future<dynamic> deleteAccount(
      DeleteAccountRequestBody deleteRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
