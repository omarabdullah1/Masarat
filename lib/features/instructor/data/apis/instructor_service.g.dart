...
part of 'instructor_service.dart';
...
class _InstructorService implements InstructorService {
  _InstructorService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<InstructorCoursesResponse> getPublishedCourses({
    ...
    final _options = _setStreamType<InstructorCoursesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late InstructorCoursesResponse _value;
    try {
      _value = InstructorCoursesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<CreateCourseResponse> createCourse(
    ...
    _data.addAll(createCourseRequestBody.toJson());
    final _options = _setStreamType<CreateCourseResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreateCourseResponse _value;
    try {
      _value = CreateCourseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<UpdateCourseResponse> updateCourse(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updateCourseRequestBody.toJson());
    final _options = _setStreamType<UpdateCourseResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateCourseResponse _value;
    try {
      _value = UpdateCourseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<LessonModel> updateLesson(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(lessonData);
    final _options = _setStreamType<LessonModel>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LessonModel _value;
    try {
      _value = LessonModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
