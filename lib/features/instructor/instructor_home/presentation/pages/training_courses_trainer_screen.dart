...
import 'package:masarat/features/instructor/instructor_home/data/apis/home_api_constants.dart';
...
import 'package:masarat/features/instructor/instructor_home/presentation/widgets/published_courses_bloc_listener.dart';
...
class _TrainingCoursesTrainerScreenState
  ...
  void initState() {
    ...
    context.read<PublishedCoursesCubit>().getPublishedCourses();
  }
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            ...
                            child: CourseCard(
                              ...
                              image: HomeApiConstants.imageUrl(course
                                      .coverImageUrl
