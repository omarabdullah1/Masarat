                ...
                children: [
                  ...
                  DrawerItem(
                    ...
                    onTap: () {
                      ...
                      context.goNamed(AppRoute.instructorProfile);
                    },
                  ),
                  _divider(),
                  ...
                  DrawerItem(
                    ...
                    onTap: () {
                      Scaffold.of(context).closeDrawer();
                      context.goNamed(AppRoute.instructorCoursesManagement);
                    },
                  ),
                  _divider(),

                  // Instructor Courses Management - Instructor specific
                  DrawerItem(
                    title: 'إدارة الــدورات',
                    onTap: () {
                      Scaffold.of(context).closeDrawer();
                      context.goNamed(AppRoute.instructorCoursesManagement);
                    },
                  ...
                  // Create New Course - Instructor specific
                  DrawerItem(
