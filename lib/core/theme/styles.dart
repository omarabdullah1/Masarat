...
class TextStyles {
  ...
  static TextStyle font24greyBold = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.bold,
    color: AppColors.gray,
  );
  static TextStyle font24greyLight = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.light,
    color: AppColors.gray,
  );
  static TextStyle font18greyLight = TextStyle(
    fontSize: 14.sp,
  ...
  static TextStyle font13DarkGreenMedium = TextStyle(
    fontSize: 13.sp,
